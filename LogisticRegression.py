...
#reading the datasets 
    ...
    X_train, X_test, y_train, y_test = train_test_split(
       df_features , df_labels['label'], test_size=0.3, 
    )
    ...
    model = LogisticRegression(max_iter=100000,penalty='l1', solver='liblinear')
    ...
    print()
    print("Metrics of Logistic Regression Classifier with PCA-------------")
    print()
    print("Accuarcy:")
    print(acc)
    print()
    ...
    acc = accuracy_score(y_transformed1, y_pred)
    print()
    print("Metrics of Logistic Regression Classifier without PCA-------------")
    print()
    print("Accuarcy:")
    print(acc)
    print()
